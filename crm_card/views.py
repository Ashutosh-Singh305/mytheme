...
def field_access_control_view(request):
    ...
    model_choices = [(m.__name__,m._meta.verbose_name.title())
        for m in models
    ...
    if selected_model:
        ...
        # Get fields from admin fieldsets
        if admin_class:
        ...
        if selected_role:
            ...
            access_controls = (
                FieldAccessControl.objects.filter(
